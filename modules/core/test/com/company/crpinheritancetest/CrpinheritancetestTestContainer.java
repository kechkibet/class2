package com.company.crpinheritancetest;
...
public class CrpinheritancetestTestContainer extends TestContainer {

    public CrpinheritancetestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/crpinheritancetest/app.properties",
    ...
    public static class Common extends CrpinheritancetestTestContainer {

        public static final CrpinheritancetestTestContainer.Common INSTANCE = new CrpinheritancetestTestContainer.Common();
